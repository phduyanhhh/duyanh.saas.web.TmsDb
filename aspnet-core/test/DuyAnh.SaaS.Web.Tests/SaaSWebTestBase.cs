...
using DuyAnh.SaaS.Models.TokenAuth;
...
public abstract class SaaSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static SaaSWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(SaaSWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<SaaSDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<SaaSDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<SaaSDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<SaaSDbContext, Task<T>> func)
    {
        T result;
