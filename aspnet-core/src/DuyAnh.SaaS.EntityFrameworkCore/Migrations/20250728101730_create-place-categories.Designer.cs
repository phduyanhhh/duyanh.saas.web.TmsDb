...
namespace DuyAnh.SaaS.Migrations
{
    ...
    [Migration("20250728101730_create-place-categories")]
    partial class createplacecategories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DuyAnh.SaaS.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DuyAnh.SaaS.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DuyAnh.SaaS.Entities.PlaceCategories", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("DuyAnh.SaaS.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("DuyAnh.SaaS.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("DuyAnh.SaaS.Authorization.Roles.Role", b =>
                {
                    b.HasOne("DuyAnh.SaaS.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("DuyAnh.SaaS.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("DuyAnh.SaaS.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
